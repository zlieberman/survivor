...
{
    /// <summary>
    /// Simple underwater effect that works with Built-in Render Pipeline
    /// </summary>
    public class SimpleUnderwaterEffect : MonoBehaviour, IUnderwaterEffect
    {
        ...
        private void InitializeEffects()
        {
            ...
            if (playerCamera == null)
            {
                Debug.LogWarning("[SimpleUnderwaterEffect] No camera found! Underwater effects will not work.");
                return;
            }
            ...
            // Create overlay material if not assigned
        ...
        {
            // Create a simple overlay shader
            string shaderCode = @"
        ...
        private void ApplyScreenOverlay(float intensity)
        {
            if (overlayMaterial != null)
            {
                ...
                // Draw the overlay
                Graphics.Blit(null, null, overlayMaterial);
            }
        }
